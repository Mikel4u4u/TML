...
операторов) bt : X ! R, корректирующей операции <img src="http://latex.codecogs.com/gif.latex?b_{t}&space;:&space;X&space;\rightarrow&space;R" title="b_{t} : X \rightarrow R" /> и решающего правила C : R ! Y :

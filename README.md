...
Xj соответствует предикат вида <a href="https://www.codecogs.com/eqnedit.php?latex=”X_{j}&space;≥&space;δ_{j}^{v}&space;”,&space;где&space;δ_{j}^{v}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?”X_{j}&space;≥&space;δ_{j}^{v}&space;”,&space;где&space;δ_{j}^{v}" title="”X_{j} ≥ δ_{j}^{v} ”, где δ_{j}^{v}" /></a> - некоторый пороговый параметр.

...
Определение
Композицией алгоритмов <a href="http://latex.codecogs.com/gif.latex?a_{t}(x)&space;=&space;C(b_{t}(x)),&space;t&space;=&space;1,&space;...&space;,T" > , называется суперпозиция базовых алгоритмов (алгоритмических
